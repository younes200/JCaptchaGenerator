...
import com.octo.captcha.component.word.wordgenerator.ConstantWordGenerator;
 ...
 * @version 1.0
 */
public class CustomEngine extends ListImageCaptchaEngine {


    String constants = null;

    public CustomEngine(String constants){
        super();
    ...
    protected void buildInitialFactories() {
        ...
        if(this.constants == null){
                dictionnaryWords   = new com.octo.captcha.component.word.wordgenerator.RandomWordGenerator(
                        "1234567890");
        }else{
                dictionnaryWords = new ConstantWordGenerator(this.constants);
        }
        ...
        FontGenerator shearedFont = new RandomFontGenerator(60,
                60,
                new Font[]{
                        new Font("nyala",Font.BOLD, 60)
                        ,
